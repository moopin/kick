...
RfuBot=[lineMID]
Family=["uac94713fed3a310794d94a4c192815cb",lineMID]
admin=['uac94713fed3a310794d94a4c192815cb',lineMID]
...
settings = {
    ...
    "cName":"",
    "cNames":"",
    "welcome":"🐶ยินดีต้อนรับ หนุ่มหล่อ & สาวสวย🐶",
    "bye":"อ้าววว!! รีบไปไหน ขอยืมตังก่อน 👻",
    "invite": {},
    "winvite": False,
    "pnharfbot": {},
    "pname": {},
    "pro_name": {},
    "message":"แอดมา มีไรค๊าบ ~",
    "comment":"ขอบคุณที่แอดมานะค๊าบ!",
    "Respontag":"แทคทำไม คนกำลังง่วง อยากจุ๊บเค้าเหรอ😝",
    "userAgent": [
...
def myhelp():
    myHelp =      " 💥คำสั่ง  💨 เรียกดูคำสั่ง😶"+ "  \n" + \
                  ...
                  " ⛳1ลบรัน  💨 ลบรัน🏆"+ "  \n" + \
                  " 🏈เช็คดำ  💨 เช็ครายการดำ🏉"+ "  \n" + \
                  " 🎶เปิดบล็อค  💨 ออโต้บล้อคเปิด🎤"+ "  \n" + \
                  " 📯ปิดบล็อค  💨 ออโต้บล็อคปิด🎧"+ "  \n" + \
                  " 🔌เปิดเข้า 💨 เข้าห้องออโต้เปิด🎻"+ "  \n" + \
                  " 📻ปิดเข้า  💨 เข้าห้องออโต้ปิด📱"+ "  \n" + \
                  " 🎷เปิดแชทรวม  💨 กันดึงแชทรวมเปิด🎸"+ "  \n" + \
                  " 🎼ปิดแชทรวม 💨 กันดึงแชทรวมปิด🎹"+ "  \n" + \
                  " 📣เปิดอ่าน  💨 เปิดระบบอ่าน📢"+ "  \n" + \
                  " 📞ปิดอ่าน  💨 ปิดระบบอ่าน🔔"+ "  \n" + \
                  "🔎เปิดเช็คติ้ก  💨 ระบบเช็คติ้กเปิด🔍"+ "  \n" + \
                  " 📁ปิดเช็คติ้ก  💨 ระบบเช็คติ้กปิด📂"+ "  \n" + \
...
#                    line.sendMessage(to, "Success Restarting.")
                    ...
                    try:
                        arr = []
                        owner = "uac94713fed3a310794d94a4c192815cb"
...
#==============================================================================#
                    ...
                    try:
                        ret_ = "   ⚔️ Sęłf ßÿ.═हई۞ Ҩ௮ูചิ้এ ۞ईह═ ⚔️ "
...
#===================================================================#              
                    ...
                    num=1
                    msgs="⚔️ Sęłf ßÿ.•═हई۞ Ҩ௮ูചิ้এ ۞ईह═• ⚔️"
                    for ids in kontak:
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['ใครแอบอ่าน ขอให้เซ็กเสื่อม']
